...
export const sidebarSections = [
  ...
  // إدارة التدريب
  {
    ...
    items: [
      ...
      { id: 'exercise-library', label: 'مكتبة التمارين', icon: BookOpen, path: '/training/exercise-library' },
      { id: 'all-users', label: 'جميع المستخدمين', icon: UserCircle, path: '/training/all-users' }
