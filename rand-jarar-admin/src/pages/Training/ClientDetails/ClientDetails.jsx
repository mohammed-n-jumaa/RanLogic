...
const ClientDetails = () => {
  ...
  const getImageUrl = (path) => {
    ...
    if (cleanPath.startsWith('/storage')) {
      return `${STORAGE_URL}${cleanPath.replace('/storage', '')}`;
    }
  ...
  const fetchClientDetails = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        console.log('Avatar path:', data.user?.avatar);
  ...
  const avatarUrl = getImageUrl(client.avatar);
  const showAvatar = client.avatar && !imageError[client.id] && avatarUrl;
          ...
          {client.subscription_start_date && (
            <div className="info-stat">
              ...
              <div className="info-stat__content">
                ...
                <span className="info-stat__value">{formatDate(client.subscription_start_date)}</span>
              </div>
            </div>
          )}
          ...
          {client.subscription_end_date && (
            <div className="info-stat">
              ...
              <div className="info-stat__content">
                ...
                <span className="info-stat__value">{formatDate(client.subscription_end_date)}</span>
              </div>
            </div>
          )}
        </div>
