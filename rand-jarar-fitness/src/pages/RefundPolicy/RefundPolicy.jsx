...
const RefundPolicy = () => {
  ...
  const content = {
    ar: {
      seoTitle: 'سياسة  الاسترجاع | RanLogic',
      seoDescription:
        'اطلع على سياسة  الاسترجاع الخاصة باشتراكات وخدمات RanLogic التدريبية الرقمية.',
      ...
      sections: [
        ...
        },
        {
          title: 'الاستثناءات',
          body: [
            'لا توجد استثناءات عامة على سياسة  الاسترجاع ما لم يثبت وجود خطأ تقني واضح أدى إلى تحصيل المبلغ أكثر من مرة لنفس الطلب.',
            'في حال وجود مشكلة دفع مكررة مثبتة، سيتم التحقق منها ومعالجتها حسب الحالة.'
          ]
        }
      ],
      note:
        'إتمام الدفع والاشتراك في المنصة يعني موافقتك الكاملة على سياسة  الاسترجاع هذه.'
    },
    en: {
      seoTitle: ' Refund Policy | RanLogic',
      seoDescription:
        'Read the  Refund Policy that applies to RanLogic digital subscriptions and coaching services.',
      badge: ' Refund Policy',
      title: ' Refund Policy',
      subtitle:
      ...
      note:
        'By completing payment and subscribing to the platform, you fully agree to this  Refund Policy.'
    }
  };
